...
export default function App() {
  ...
  return (
    <SmoothScroll>
      {/* overflowX: 'clip' hides horizontal scrollbars but strictly preserves position: sticky! */}
      <div className="app" style={{ background: '#0a0a0c', minHeight: '100vh', overflowX: 'clip', position: 'relative', fontFamily: 'Inter, sans-serif' }}>
            ...
            >
              ...
              <section id="studio" style={{ position: 'relative', zIndex: 10, padding: '40px 5vw', paddingBottom: '100px', maxWidth: '1600px', margin: '0 auto' }}>
                <main className="main" style={{ background: 'rgba(20, 20, 25, 0.4)', borderRadius: '24px', padding: '40px', border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(10px)' }}>
                  ...
                  {/* Three-column grid: original | pipeline | dream */}
  ...
  DeepDream Studio · built with{' '}
  <a href="https://pytorch.org" target="_blank" rel="noopener noreferrer" style={{ color: '#3c78ff', textDecoration: 'none' }}>
    PyTorch
  </a>{' '}
  &{' '}
  <a href="https://fastapi.tiangolo.com" target="_blank" rel="noopener noreferrer" style={{ color: '#34d399', textDecoration: 'none' }}>
    FastAPI
  </a>
</footer>
